...
#-----------------------------------
eeg1 = ADC(Pin(34))#eeg1
eeg2 = ADC(Pin(35))#eeg2
eeg3 = ADC(Pin(32))#eeg3
eeg4 = ADC(Pin(33))#eeg4
eeg5 = ADC(Pin(25))#eeg5
eeg6 = ADC(Pin(26))#eeg6
emg7 = ADC(Pin(27))#emg1
#-----------------------------------
...
# tim = Timer(-1)
# tim.init(period=120520, mode=Timer.ONE_SHOT, callback=tim_isr) 
...
#     str_cu_dt= str(cu_dt)
    ...
    print("{:04d}-{:02d}-{:02d}_{:02d}-{:02d}-{:02d}.txt".format(year, month, day, hour, minute, second))
